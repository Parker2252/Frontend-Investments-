                  ...
                  <form ref="form">
                    <div class="container-fluid">
                      <div class="form-group row justify-content-around py-2">
                        ...
                        <div class="col col-8">
                          <input v-model="stock.cust_number" type="number" class="form-control-sm form-control">
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                      ...
                      <div class="form-group row justify-content-around py-2">
                        ...
                        <div class="col col-8">
                          <input v-model="stock.address" type="text" class="form-control-sm form-control">
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">City</label>
                        <div class="col col-8">
                          <input v-model="stock.city" type="text" class="form-control-sm form-control">
                        </div>
                      </div> 
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">State</label>
                        <div class="col col-8">
                          <input v-model="stock.state" type="text" class="form-control-sm form-control">
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Zip Code</label>
                        <div class="col col-8">
                          <input v-model="stock.zipcode" type="text" class="form-control-sm form-control">
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Email</label>
                        <div class="col col-8">
                          <input v-model="stock.email" type="text" class="form-control-sm form-control">
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Phone</label>
                        <div class="col col-8">
                          <input v-model="stock.cell_phone" type="text" class="form-control-sm form-control">
                        </div>
                      </div>                    
